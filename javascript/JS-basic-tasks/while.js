...
function repeatChar(str,chr) { 
    ...
    let count=0; 
    while(i<str.length){ 
        if(str[i]==chr.toLowerCase() || str[i] == chr.toUpperCase()) { 
            count++ ;
...
console.log(repeatChar('Mohammad' ,'m')) ;
