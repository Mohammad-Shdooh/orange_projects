...
<header class="page-header">
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="controlDB.php?name=Add&id=0">
          <svg>
            <use xlink:href="#users"></use>
          </svg>
          <span class="text-light">Add Article</span>
        </a>
      </li>
      <li>
        <a href="newsPage.php">
      ...
      <li>
        <a href="#0">
          ...
          <span class="text-light">Collection</span>
        </a>
      </li>
      <li>
        <a href="#0">
      ...
      <li>
        <a href="#0">
          ...
          <span class="text-light">Appearance</span>
        </a>
      </li>
      <li class="menu-heading">
      ...
      <li>
        <a href="#0">
          ...
          <span class="text-light">Options</span>
        </a>
      </li>
      <li>
        <a href="#0">
          ...
          <span class="text-light">Charts</span>
        </a>
      </li>
      <li>
        <div class="switch">
      ...
      while($row=$result->fetch_assoc()){ 
          echo "<article>" ;
           echo  '<a href=mainPage.php?id='.$row['id'].'>'  ;
             echo '<div class="w-75">';
                echo "<img class='w-75 ' style='box-shadow:5px 5px 5px 5px gray;' src='".$row['image']."'/>";
             echo '</div>';
           ...
           echo "<div>";
             ...
             echo  '<a class="btn" href='."controlDB.php".'?id='.$row['id']."&name=delete".'>' .'delete'  ;
             echo "</a>";       
                echo " <br/> ";
             echo  '<a class="btn" href='."controlDB.php".'?id='.$row['id']."&name=edit".'>' .'Edit'  ;
               echo "<br/>"; 
