...
//Creating unordered list to display result.
   ...
   <div class="container" >
  <a  href="../sidebar-09/profile.php?id=<?= $Result['id']; ?>" class="d-flex">
  ...
  echo' <div class="w-25 pr-2">
   ...
   echo' <div class="w-25 pr-2">
   <img class="w-100 rounded-circle " src="https://cdn-icons-png.flaticon.com/512/21/21104.png' .$Result['profile_pic'].'" alt="prof">
</div>';
}  ?>
