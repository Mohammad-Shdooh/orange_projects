   ...
   <!-- <br /> -->
    ...
    <ul class="navbar-nav ">
      <li class="nav-item active">
        <a class="nav-link" href="../user_interface/index.php">Home <span class="sr-only">(current)</span></a>
      </li>
   ...
   <?php }else{?>
    ...
    <?php echo $_SESSION['username']?> 
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="../user_interface/editprofile.php">Edit Profile </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="../user_interface/logout.php">Logout</a>
        </div>
      </li>
